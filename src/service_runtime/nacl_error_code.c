...
char const *NaClErrorString(NaClErrorCode errcode)
{
  switch(errcode)
  {
    ...
    case SRT_NO_SEG_SEL:
       ...
       */
    case LOAD_0MQ_CONTEXT_INIT_FAILED:
      return "0MQ context init failed.";
    case LOAD_0MQ_CONTEXT_TERM_FAILED:
      return "0MQ context termination failed.";
    case LOAD_0MQ_SOCKET_ERROR:
      return "0MQ socket opening/closing failed.";
    case LOAD_ITEM_ALREADY_EXIST:
      return "Trying to open communication channel using duplicate file descriptor.";
    case LOAD_SQL_STATEMENT_EXEC_ERROR:
      return "Error executing sql query in the channels database.";
    case LOAD_APPLICATIVE_NETWORK_ERROR:
      return "Unhandled incoming channel data registered after completion of user code.";

      /* invalid error code */
    case NACL_ERROR_CODE_COUNT:
      break;
  }
