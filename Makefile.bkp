...
obj/manifest_parser_test.o: src/service_runtime/manifest_parser_test.cc
	@g++ ${CXXFLAGS} -o obj/manifest_parser_test.o ${CXXFLAGS1} src/service_runtime/manifest_parser_test.cc
...
obj/zmq_syscalls_test.o: src/service_runtime/zmq_syscalls_test.cc
	@g++ ${CXXFLAGS} -o obj/zmq_syscalls_test.o ${CXXFLAGS1} src/service_runtime/zmq_syscalls_test.cc
...
######################################################################## compilation to obj
obj/md5.o: src/service_runtime/md5.c
	@gcc ${CCFLAGS} -o obj/md5.o ${CCFLAGS0} ${CCFLAGS1} ${CCFLAGS4} src/service_runtime/md5.c
...
obj/manifest_parser.o: src/service_runtime/manifest_parser.c
	@gcc ${CCFLAGS} -o obj/manifest_parser.o ${CCFLAGS0} ${CCFLAGS1} src/service_runtime/manifest_parser.c

obj/zmq_syscalls.o: src/service_runtime/zmq_syscalls.c
	@gcc ${CCFLAGS} -o obj/zmq_syscalls.o ${CCFLAGS0} ${CCFLAGS1} src/service_runtime/zmq_syscalls.c
