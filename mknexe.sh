...
~/nacl/native_client/toolchain/linux_x86/bin/x86_64-nacl-gcc -o $1_x86_64.nexe -s -static -T ~/nacl/native_client/toolchain/linux_x86/x86_64-nacl/lib/ldscripts/elf64_nacl.x.static -melf64_nacl -m64 killme.o ~/git/zerovm/api/zvm.o
