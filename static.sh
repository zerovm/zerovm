...
###############################################################################
g++ -o zvm -O3 -s -static -Wl,-z,noexecstack -Wl,-z,relro -Wl,-z,now obj/zerovm.o obj/manifest.o obj/setup.o obj/channel.o obj/qualify.o obj/report.o obj/zlog.o obj/signal_common.o obj/signal.o obj/to_app.o obj/switch_to_app.o obj/to_trap.o obj/syscall_hook.o obj/prefetch.o obj/preload.o obj/userspace.o obj/usermap.o obj/context.o obj/trap.o obj/etag.o obj/accounting.o obj/daemon.o obj/ztrace.o obj/serializer.o -Lobj -L/usr/lib -L/usr/local/lib -lglib-2.0 -pthread -luuid -lrt /home/bortoq/git/validator/out/Release/libvalidator.a -L/usr/local/lib -lzvm_zpipes -lzbroker_cli -lzmtp
