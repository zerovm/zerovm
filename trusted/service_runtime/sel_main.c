...
#include "shared/imc/nacl_imc_c.h"
...
#include "trusted/service_runtime/env_cleanser.h"
#include "trusted/service_runtime/include/sys/fcntl.h"
#include "trusted/service_runtime/nacl_app.h"
#include "trusted/service_runtime/nacl_all_modules.h"
#include "trusted/service_runtime/nacl_config_dangerous.h"
...
#include "trusted/service_runtime/sel_qualify.h"

#if (NACL_WINDOWS && NACL_ARCH(NACL_BUILD_ARCH) == NACL_x86 && \
     NACL_BUILD_SUBARCH == 64)
#include "trusted/service_runtime/win/exception_patch/ntdll_patch.h"
#endif
