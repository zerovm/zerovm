...
#include "trusted/validator/x86/ncval_reg_sfi/ncvalidator_registry.h"

#include "shared/platform/nacl_log.h"
#include "trusted/validator/x86/decoder/nc_inst_state.h"
#include "trusted/validator/x86/decoder/ncop_exps.h"
#include "trusted/validator/x86/ncval_reg_sfi/ncvalidate_iter.h"
#include "trusted/validator/x86/ncval_reg_sfi/ncvalidate_iter_internal.h"
#include "trusted/validator/x86/ncval_reg_sfi/nc_jumps.h"
#include "trusted/validator/x86/ncval_reg_sfi/nc_cpu_checks.h"
#include "trusted/validator/x86/ncval_reg_sfi/nc_illegal.h"
#include "trusted/validator/x86/ncval_reg_sfi/nc_jumps.h"
#include "trusted/validator/x86/ncval_reg_sfi/nc_opcode_histogram.h"
#include "trusted/validator/x86/ncval_reg_sfi/nc_memory_protect.h"
#include "trusted/validator/x86/ncval_reg_sfi/nc_protect_base.h"

#include "trusted/validator/x86/decoder/nc_inst_iter_inl.c"
